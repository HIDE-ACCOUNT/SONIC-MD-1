...
let handler = async function (m, { conn, text, usedPrefix, command }) {
  ...
  if (user.registered === true) throw `💝 You are already registered with 💝 SONIC-MD 💝\n\n🇱🇰 Do you want to re-register to 💝 SONIC-MD 💝 ?🇱🇰\n\n 🇱🇰 Use this command to remove your register 🇱🇰\n*.unhentai* (Serial number)`
  if (!Reg.test(text)) throw `🇱🇰 Format incorrect\n\n 🇱🇰 Use this command of 💝 SONIC-MD 💝: *.qhw name.age*\n💝Exemple : *.qhw* Kalindu.16`
